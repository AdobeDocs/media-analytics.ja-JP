...
| **XDM コレクションフィールド** | [`mediaCollection.sessionDetails.friendlyName`](https://experienceleague.adobe.com/ja/docs/experience-platform/xdm/data-types/session-details-collection) |
