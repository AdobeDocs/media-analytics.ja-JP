...
| **XDM コレクションフィールド** | [`mediaCollection.sessionDetails.album`](https://experienceleague.adobe.com/ja/docs/experience-platform/xdm/data-types/session-details-collection) |
