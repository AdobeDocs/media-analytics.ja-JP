...
| **XDM コレクションフィールド** | [`mediaCollection.sessionDetails.rating`](https://experienceleague.adobe.com/ja/docs/experience-platform/xdm/data-types/session-details-collection) |
