...
>[!MORELIKETHIS]
>
>* [&#x200B; ディメンションの概要](../dimensions/overview.md): ストリーミングメディアディメンション参照
>* [計算指標](/help/reporting/calculated-metrics.md)：上記の基本指標から構築された比率と派生指標
>* [&#x200B; パラメーターマッピング &#x200B;](/help/implementation/parameters-mapping.md)：イベントから列、XDMへの完全な参照
>* [&#x200B; イベントの概要](/help/implementation/events/overview.md)：指標の計算を促進するプレイヤーイベント
