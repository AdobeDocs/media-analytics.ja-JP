...
Customer Journey Analyticsでは、`mediaReporting.qoeDataDetails.stallCount`を指標として使用することも、ディメンションのコンポーネントを別個にすることなくディメンションとして使用することもできます。
...
| Customer Journey Analytics | [`mediaReporting.qoeDataDetails.stallCount`](https://experienceleague.adobe.com/ja/docs/experience-platform/xdm/data-types/qoe-data-details-reporting) |
