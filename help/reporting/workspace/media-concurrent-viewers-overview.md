...
description: メディア同時視聴者数パネルを使用して同時視聴者数を分析し、同時視聴者数とドロップオフのピークを把握する方法を説明します。
...
また、Analytics レポート API 2.0を使用して、最大1か月間の同時視聴者データを分単位で取得することもできます。  レポート APIでは、Analysis Workspaceと同じ同時視聴者数の定義を使用します。  詳しくは、[_*Analytics 2.0 API を使用した同時視聴者の JSON レポートデータの取得*_](/help/reporting/reports-and-analytics/get-concurrent-json20.md)&#x200B;を参照してください。
