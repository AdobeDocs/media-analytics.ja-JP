...
ポッドの位置は、`media.adBreakStart`にプレーヤーが設定した[広告休止開始時間](/help/implementation/variables/ads/ad-break-start-time.md)の値から設定されます。
...
| Customer Journey Analytics | [`mediaReporting.advertisingPodDetails.offset`](https://experienceleague.adobe.com/ja/docs/experience-platform/xdm/data-types/advertising-pod-details-reporting) |
...
各項目は、`media.adBreakStart`に報告された整数オフセット値（秒単位）です。
