...
マイルストーン実装のビデオレポートを設定するには、に進み **[!UICONTROL Admin > Report Suite Manager]ます。**レポートスイートを選択し、次を選択しま**[!UICONTROL Video Management > Video Reporting]す。**
...
最初の画面では、マイルストーンデータと共に使用できるのはビデオコアのみです。を選択 **[!UICONTROL Video Core]** し、をクリックし **[!UICONTROL Save]ます。**

![](assets/video-core-check.png)

次の画面で、を選択し **[!UICONTROL Use Custom Variables]ます。**
