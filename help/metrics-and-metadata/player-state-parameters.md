...
|   実装   | ネットワークパラメーター | レポート |
| --- | --- | --- |
| <ul> <li> **SDKキー&#x200B;**<br/>：自動的に設定</li> <li> **APIキー&#x200B;**<br/>該当なし</li> <li> **必須&#x200B;**<br/>No</li> <li> **タイプ&#x200B;**<br/>番号</li> <li> **メディアを閉じると共に送信&#x200B;**<br/></li> <li> **最小のSDK Version **<br/>3.0</li> <li> **サンプル値&#x200B;**<br/>TRUE</li><li> ****<br/>説明クローズドキャプションが表示された時間の長さ。 This metric is set to 1 only if at least one Full Screen State occurred during a playback session.<br/> **重要&#x200B;**<br/>：このイベントを設定した場合、時間は、ビデオがクローズドキャプション状態であった時間と等しくなります。 このイベントが設定されていない場合、値は送信されません。</li> </ul> | <ul> <li> **Adobe Analytics **<br/>(media.states.closedcaptioning.time)<br/></li> <li> **ハートビート&#x200B;**<br/>N/A</li> </ul> | <ul> <li> **使用可能&#x200B;**<br/>Yes</li> <li> **予約変数&#x200B;**<br/>イベント</li> <li> **レポート名&#x200B;**<br/>Closed Captioning Total Duration</li> <li> **コンテキストデータ&#x200B;**<br/>(media.states.closedcaptioning.time)<br/> </li> <li> **データフィード&#x200B;**<br/>media.states.closedcaptioning.time</li> <li> **オーディエンスマネージャ&#x200B;**<br/>(c_contextdata.media.states.closedcaptioning.time)</li> </ul> |
...
|   実装   | ネットワークパラメーター | レポート |
| --- | --- | --- |
| <ul> <li> **SDKキー&#x200B;**<br/>：自動的に設定</li> <li> **APIキー&#x200B;**<br/>該当なし</li> <li> **必須&#x200B;**<br/>No</li> <li> **タイプ&#x200B;**<br/>番号</li> <li> **メディアを閉じると共に送信&#x200B;**<br/></li> <li> **最小のSDK Version **<br/>3.0</li> <li> **サンプル値&#x200B;**<br/>TRUE</li><li> ****<br/>説明図の中の図が表示された回数です。 This metric is set to 1 only if at least one Picture in Picture State occurred during a playback session.<br/> **重要**<br/> このイベントを設定した場合、カウントは、ビデオがピクチャインピクチャ状態だった回数と等しくなります。 このイベントを設定しない場合は、値が送信されません。   </li> </ul> | <ul> <li> **Adobe Analytics **<br/>(media.states.pictureinpicture.count)<br/></li> <li> **ハートビート&#x200B;**<br/>N/A</li> </ul> | <ul> <li> **使用可能&#x200B;**<br/>Yes</li> <li> **予約変数&#x200B;**<br/>イベント</li> <li> **画像数のレポート名&#x200B;**<br/>：画像</li> <li> **コンテキストデータ&#x200B;**<br/>(media.states.pictureinpicture.count)<br/> </li> <li> **データフィード&#x200B;**<br/>media.states.pictureinpicture.count</li> <li> **オーディエンスマネージャ&#x200B;**<br/>(c_contextdata.media.states.pictureinpicture.count)</li> </ul> |
...
|   実装   | ネットワークパラメーター | レポート |
| --- | --- | --- |
| <ul> <li> **SDKキー&#x200B;**<br/>：自動的に設定</li> <li> **APIキー&#x200B;**<br/>該当なし</li> <li> **必須&#x200B;**<br/>No</li> <li> **タイプ&#x200B;**<br/>番号</li> <li> **メディアを閉じると共に送信&#x200B;**<br/></li> <li> **最小のSDK Version **<br/>3.0</li> <li> **サンプル値&#x200B;**<br/>TRUE</li><li> ****<br/>説明図の中の図が表示された時間の長さです。 This metric is set to 1 only if at least one Picture in Picture State occurred during a playback session.<br/> **重要**<br/> このイベントを設定した場合、時間は、ビデオがピクチャインピクチャ状態にあった時間と等しくなります。 このイベントが設定されていない場合、値は送信されません。   </li> </ul> | <ul> <li> **Adobe Analytics **<br/>(media.states.pictureinpicture.time)<br/></li> <li> **ハートビート&#x200B;**<br/>N/A</li> </ul> | <ul> <li> **使用可能&#x200B;**<br/>Yes</li> <li> **予約変数&#x200B;**<br/>イベント</li> <li> **画像内のレポート名&#x200B;**<br/>Picture （画像合計時間）</li> <li> **コンテキストデータ&#x200B;**<br/>(media.states.pictureinpicture.time)<br/> </li> <li> **データフィード&#x200B;**<br/>media.states.pictureinpicture.time</li> <li> **オーディエンスマネージャ&#x200B;**<br/>(c_contextdata.media.states.picture.time)</li> </ul> |
