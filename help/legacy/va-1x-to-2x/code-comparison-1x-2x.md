---
title: v1.x と v2.x のコードの比較
description: Media SDK のバージョン 1.x と 2.x のコードの違いについて説明します。
...
2.x を使用したビデオの追跡について詳しくは、「[コアビデオ再生の追跡](/help/use-cases/track-av-playback/track-core-overview.md)」を参照してください。
