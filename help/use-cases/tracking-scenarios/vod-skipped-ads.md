...
パラメーターは、広告完了呼び出しがない場合を除き、プレロール広告[&#128279;](/help/use-cases/tracking-scenarios/vod-preroll-ads.md) シナリオでのVOD再生のパラメーターと同じです。 スキップして広告枠を閉じるには、引き続き`AdBreakComplete`が必要です。
